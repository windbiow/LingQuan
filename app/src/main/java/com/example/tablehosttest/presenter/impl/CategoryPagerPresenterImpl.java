...
public class CategoryPagerPresenterImpl implements ICategoryPagerPresenter {
    ...
    @Override
    public void getContentById(int materialId) {
    ...
    //调用网络问题处理回调函数
    private void handleNetWorkError(int materialId) {
            for(ICategoryPagerCallback callback:callbackList){
                if(callback.getMaterialId()!=materialId){
    ...
    //调用数据接收成功回调函数
    private void handleHomePageContentResult(HomePagerContent pagerContent,int materialId) {
